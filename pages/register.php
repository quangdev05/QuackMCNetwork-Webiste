<?php
$pageTitle = "Đăng ký | QuackMC Network";
                ...
                <section class="main">
                    ...
                    <form action="" method="POST" class="form-wrapper" id="form">
                        ...
                        <div class="tos">
                            ...
                            <label for="term">Đồng ý với <a href="/terms" target="_blank" class="text-blue-500">Điều
                                    khoản</a> của PlayST</label><br>
                        </div>
                        <button type="submit" name="action" value="Register" id="btn-submit" class="btn-submit">Đăng
                            ký</button>
                    </form>
                    <div class="sub-form">
                    ...
                    <div class="sub-form !block">
                        Vui lòng đọc và tuân thủ theo <a href="/terms" target="_blank" class="text-blue-500">Điều khoản
                            dịch vụ</a> của PlayST. Chúng tôi sẽ khoá tài khoản của bạn nếu bạn có các hành vi không phù
                        hợp và sẽ không giải quyết bất kỳ các khiếu nại nào có liên quan.
                    </div>
